      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-20 items-center relative z-10">
        ...
        <div className="lg:col-span-7 pt-12 md:pt-0">
          ...
          <p className="text-brand-surface/80 text-lg leading-relaxed mb-8 font-medium">
            Leading civil services excellence since 2015, our Founder has transformed <span className="text-brand-gold font-bold">Kartavya IAS</span> into the premier destination for UPSC preparation. With a deep commitment to student success and profound academic brilliance, the leadership drives our results-oriented approach.
          </p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-2 gap-6 mb-10">
            ...
            <div className="bg-[#002670]/40 backdrop-blur-md border border-brand-blue/50 rounded-2xl p-6 hover:bg-[#0033a0]/80 hover:border-brand-gold/50 transition duration-300 group shadow-lg">
              ...
              <h4 className="text-xl font-bold text-white mb-2 group-hover:text-brand-gold transition-colors">Academic Excellence</h4>
              <p className="text-brand-surface/60 text-sm leading-relaxed">PhD in Economics with a deep command over India’s economic framework, M.Sc. Mathematics & Statistics (Gold Medalist) and PG in Economics.</p>
            </div>

            {/* UPSC Experience Highlight */}
            <div className="bg-[#002670]/40 backdrop-blur-md border border-brand-blue/50 rounded-2xl p-6 hover:bg-[#0033a0]/80 hover:border-brand-gold/50 transition duration-300 group shadow-lg">
              <div className="w-14 h-14 bg-blue-500/20 text-blue-400 rounded-xl flex items-center justify-center mb-5 group-hover:scale-110 transition duration-300 group-hover:bg-blue-500 group-hover:text-white shadow-inner">
              ...
              <h4 className="text-xl font-bold text-white mb-2 group-hover:text-brand-gold transition-colors">UPPCS Selection</h4>
              <p className="text-brand-surface/60 text-sm leading-relaxed">Successfully 100+ selection in Uppcs<br /> and 10 + students ias interview faced.</p>
            </div>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            ...
            <div className="bg-gradient-to-br from-brand-red to-brand-red-dark rounded-2xl p-6 border border-brand-red-light shadow-2xl shadow-brand-red/20 relative overflow-hidden flex flex-col justify-between group hover:-translate-y-1 transition duration-300">
              ...
              <Link to="/location/prayagraj" className="bg-white text-brand-red-dark hover:bg-brand-surface font-extrabold py-3 px-4 rounded-xl flex items-center justify-center gap-2 text-sm transition w-full shadow-lg hover:shadow-xl relative z-10">
            ...
            <div className="bg-gradient-to-br from-[#004eb8] to-[#0033a0] rounded-2xl p-6 border border-brand-blue-light/50 shadow-2xl shadow-brand-blue/20 relative overflow-hidden flex flex-col justify-between group hover:-translate-y-1 transition duration-300">
              ...
              <Link to="/location/delhi" className="bg-brand-gold hover:bg-yellow-400 text-[#001740] font-extrabold py-3 px-4 rounded-xl flex items-center justify-center gap-2 text-sm transition w-full shadow-lg hover:shadow-xl relative z-10">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                View Details
              </Link>
            </div>
